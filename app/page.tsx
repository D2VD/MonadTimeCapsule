...
export default function Home() {
  ...
  function submit(e: FormEvent) { e.preventDefault(); if (!contractAddress) return; writeContract({ abi: monadTimeCapsuleAbi, address: contractAddress, functionName: 'createCapsule', args: [message, BigInt(unlockAt)], value: fee }); }
